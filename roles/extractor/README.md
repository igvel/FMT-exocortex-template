...
|-------|------|---------|------|
| Мой домен | PACK-my-domain | MD | /home/igvel/repos/IWE/PACK-my-domain/pack/my-domain/ |
```

### 2. (Опционально) Установи автоматический inbox-check

```bash
cd /home/igvel/repos/IWE/FMT-exocortex-template/roles/extractor
bash install.sh
```
...
bash /home/igvel/repos/IWE/FMT-exocortex-template/roles/extractor/scripts/extractor.sh inbox-check

# Knowledge Audit
bash /home/igvel/repos/IWE/FMT-exocortex-template/roles/extractor/scripts/extractor.sh audit
```
