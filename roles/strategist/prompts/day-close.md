...
Источник сценария: /home/igvel/repos/IWE/CLAUDE.md → Протокол Day-Close

## Контекст

- **WeekPlan:** /home/igvel/repos/IWE/DS-strategy/current/WeekPlan W*.md (последний по дате)
- **MEMORY:** ~/.claude/projects/-home-igvel-repos-IWE/memory/MEMORY.md
- **Exocortex backup:** /home/igvel/repos/IWE/DS-strategy/exocortex/
...
```bash
# Для КАЖДОГО репо в /home/igvel/repos/IWE/:
git -C /home/igvel/repos/IWE/<repo> log --since="today 00:00" --oneline --no-merges
```

- Пройди по ВСЕМ репозиториям в `/home/igvel/repos/IWE/`
...
Скопируй актуальные файлы в `/home/igvel/repos/IWE/DS-strategy/exocortex/`:

```bash
# Корневой CLAUDE.md
cp /home/igvel/repos/IWE/CLAUDE.md /home/igvel/repos/IWE/DS-strategy/exocortex/CLAUDE.md

# Memory (Слой 3)
cp ~/.claude/projects/-home-igvel-repos-IWE/memory/MEMORY.md /home/igvel/repos/IWE/DS-strategy/exocortex/MEMORY.md
cp ~/.claude/projects/-home-igvel-repos-IWE/memory/*.md /home/igvel/repos/IWE/DS-strategy/exocortex/
```
