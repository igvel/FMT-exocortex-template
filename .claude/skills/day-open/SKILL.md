...
for repo in FPF SPF ZP; do
  dir="/Users/tserentserenov/IWE/$repo"
...
```
Если есть новые коммиты → добавить в «Требует внимания»: «[repo] обновлён upstream → `cd /Users/tserentserenov/IWE/[repo] && git pull --rebase`». После pull FPF/SPF → reindex: `bash /Users/tserentserenov/IWE/DS-MCP/knowledge-mcp/scripts/selective-reindex.sh FPF` (или SPF).
