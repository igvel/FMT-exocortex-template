...
```bash
for repo in $(ls /home/igvel/repos/IWE/); do
  if [ -d /home/igvel/repos/IWE/$repo/.git ]; then
    commits=$(git -C /home/igvel/repos/IWE//$repo log --since="today 00:00" --oneline --no-merges 2>/dev/null)
...
/home/igvel/repos/IWE/DS-IT-systems/DS-ai-systems/synchronizer/scripts/day-close.sh
```
